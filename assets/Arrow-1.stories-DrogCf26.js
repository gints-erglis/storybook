...
`,p=r=>`<span class="arrow arrow--${r.size} arrow--${r.direction}"></span>`,C={title:"00-Atoms/Arrows/Arrow1",component:m,parameters:{layout:"centered",docs:{source:{transform:(r,n)=>p(n.args),language:"html"},page:()=>e.jsxs(e.Fragment,{children:[e.jsx(d,{}),e.jsx("h3",{children:"CSS Code"}),e.jsx(c,{language:"css",dark:"true",code:u})]})}},tags:["autodocs"],argTypes:{color:{control:"color"}}},t={args:{direction:"top",size:"medium",color:"#666"}};var o,a,s;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    direction: 'top',
    size: 'medium',
    color: '#666'
