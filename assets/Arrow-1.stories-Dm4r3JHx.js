...
`,u=r=>`<span class="arrow arrow--${r.size} arrow--${r.direction}"></span>`,T={title:"00-Atoms/Arrows/Arrow1",component:m,parameters:{layout:"centered",docs:{source:{transform:(r,n)=>u(n.args),language:"html"},page:()=>e.jsxs(e.Fragment,{children:[e.jsx(d,{}),e.jsx("h3",{children:"CSS Code"}),e.jsx(c,{language:"css",dark:"true",code:p})]})}},tags:["autodocs"],argTypes:{color:{control:"color"}}},t={args:{direction:"top",size:"medium",color:"#666"}};var o,a,s;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    direction: 'top',
    size: 'medium',
    color: '#666'
  }
}`,...(s=(a=t.parameters)==null?void 0:a.docs)==null?void 0:s.source}}};const k=["Top"];export{t as Top,k as __namedExportsOrder,T as default};
